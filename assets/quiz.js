...
(function () {
  ...
  function loadData(type, slug, cache) {
    ...
    var timer;
    var request = fetch("../data/" + key + ".json?v=20260919-v009", controller ? { signal: controller.signal } : {}).then(function (r) {
  ...
  function loadPolicy() {
    ...
    var request = fetch("../data/review-policy.json?v=20260919-v009", controller ? { signal: controller.signal } : {}).then(function (r) {
